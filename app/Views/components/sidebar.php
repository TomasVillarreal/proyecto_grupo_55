...
<body id="body-pd">
  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div> 
        <a href="#" class="nav_logo"> <i class='bi bi-hospital nav_logo-icon'></i><span class="nav_logo-name">Clinicks</span> </a>
        <div class="nav_list"> 
            <a href="#" class="nav_link active"> <i class='bi bi-plus-circle nav_icon'></i> <span class="nav_name">Agregar medicamento</span> </a> 
            <a href="#" class="nav_link"> <i class='bi bi-pencil-square nav_icon'></i> <span class="nav_name">Modificar medicamento</span> </a> 
            <a href="#" class="nav_link"> <i class='bi bi-file-x nav_icon'></i> <span class="nav_name">Eliminar medicamento</span> </a> 
        </div>
      </div> 
    </nav>
  </div>
